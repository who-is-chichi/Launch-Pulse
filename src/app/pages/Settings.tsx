...
const sections = [
  { icon: User, title: 'User Profile', key: 'profile' },
  { icon: Bell, title: 'Notifications', key: 'notifications' },
  { icon: Database, title: 'Data Preferences', key: 'data' },
  { icon: Shield, title: 'Security', key: 'security' },
];
